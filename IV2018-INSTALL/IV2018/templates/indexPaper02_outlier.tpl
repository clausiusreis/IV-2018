...
<div id="csscontent">
    ...
    <div id="heatmap1" class="roundDiv" style="height: 320px;">
    	<div align="left"><font size=5><strong>Pre-NMF Heatmap (With outliers)</strong></font></div>
    </div>    
    <div id="heatmap2" class="roundDiv" style="height: 320px;">
    	<div align="left"><font size=5><strong>Post-NMF Heatmap (With outliers)</strong></font></div>
    </div>    
    ...
    var csvFile1 = "../DATA_PAPER1/CostaRica_015089_none_n4_outlier.csv";
    var csvFile2 = "../DATA_PAPER1/CostaRica_015089_NNMF_none_n4_outlier.csv";
